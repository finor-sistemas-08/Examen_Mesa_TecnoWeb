...
<body>
		...
		<table width="400" border="0">
			...
			<tr>
				...
				<td width="125">
					...
					<input name="txtPagoHora" type="text" value="<?php if ($pagoHora > 0) {
																		echo $pagoHora;
																	} else {
																		echo 0;
																	} ?>" />
			...
			<tr>
				...
				<td width="125">
					...
					<input name="chbxTipoD" type="checkbox" <?php if ($tipoD == 1) {
																echo "checked";
															} ?> />
				</td>
			</tr>
			<tr>
				...
				<td width="125">
					...
					<input name="chbxTipoA" type="checkbox" <?php if ($tipoA == 1) {
																echo "checked";
															} ?> />
				</td>
			</tr>
	...
	function modificar()
	{
		if ($_POST['txtIdEmpleado'] && $_POST['txtNombre'] && $_POST['txtPaterno']) {
			$obj = new Empleado();
			...
			echo "El nombre y apellido son necesarios";
		}
	}
